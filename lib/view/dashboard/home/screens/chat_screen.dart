...
//     return GetBuilder<CoursController>(
//       builder: (_) => Padding(
...
//                                           child: Center(child: Text("+ Ajouter Cours", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)),
//                                           decoration: BoxDecoration(color: Color.fromARGB(255, 77, 144, 239), borderRadius: BorderRadius.circular(15)),
//                                           ), 
//                                      ),
//                               // SizedBox(
//                               //   width: 350,
...
//                                                               context,controller.id_cours[index]);
//                                                           },
//                                                           child: Icon(
//                                                             LineIcons.trash,
//                                                             color: Colors
...
// } 
// Future<void> addCours(context) async {
...
//   Future<void> showInformationCours(
//       context, id, name, idformation, description, support) async {
//     return showDialog<void>(
//       context: context,
//       barrierDismissible: false, // user must tap button!
//       builder: (BuildContext context) {
