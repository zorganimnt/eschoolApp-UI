...
class ListFormation extends StatelessWidget {
                             ...
                             InkWell(
                                    onTap: () {
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: Text("+ Ajouter Formation", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)),
 ...
 Future<void> showInformationFormation(
      context, id, nameFormation, pictureFormation, priceFormation, formateurFormation, dureeFormation, categoryFormation, role) async {
                ...
                () {
                  ...
                  children: [
                    ...
                    ModifyInputItem(
                        ...
                        inputContent: controller.changeFormateurFormation.text,
